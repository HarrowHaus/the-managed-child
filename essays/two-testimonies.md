...
The object of this project is neither occultism nor any cabal. It is [an impulse](../data/nodes/concepts/the-root.md): *humanity is raw material — stock to be graded, guided, corrected, and administered toward a planned end by an elect fit to do it.*

The impulse surfaces in four theaters, which are one thing. Raise the stock correctly: the managed child. Breed and sort the stock: eugenics. Grade the stock spiritually: the initiated elect. Condition the stock's consent: the engineered public. These are not four threads that happen to touch. They are one conviction in four costumes, and recognizing that is what lets the ugly material sit inside the argument as evidence rather than outside it as embarrassment. Race-ranking and child-managing flow from the same source. The thesis explains the pathology; it never adopts it.

## The trunk

The root's political form is [the oldest respectable idea in Western thought](../data/nodes/concepts/rule-by-trained-elite.md): that society is properly ordered by a trained guardian minority, who shape the many — if need be through myth.
...
Applied to the young, the root produces [the managed child](../data/nodes/concepts/managed-child.md) — and here the evidence is documented sociology, primary-sourced, standing entirely without esoteric input.
...
**The institution processes.** Ellwood Cubberley, a dean at Stanford, wrote in *Public School Administration* (1916) that "our schools are, in a sense, factories in which the raw products (children) are to be shaped and fashioned into products to meet the various demands of life," requiring the "elimination of waste" and the "continuous measurement of production." A schooling administrator supplied the manufacturing metaphor himself.
...
Alongside this machinery, and never inside it, [a second register](../data/nodes/concepts/four-idiom-through-line.md) was saying the quiet part aloud. One motif — an initiated elect administering human development toward a planned end — recurs in four idioms across seventy years.

**The Aeon.** Crowley's *Liber AL vel Legis*, received in Cairo in April 1904, declares the new age the age of the Crowned and Conquering Child. Its tenth verse states the elect and the many in a single line: "Let my servants be few & secret: they shall rule the many & the known." A sovereign child and a few who rule the many, welded inside the same document. The primary text makes the connection; no reader imposes it.
...
**The Nine.** Andrija Puharich's decades of channeled-entity research centered on a council calling itself the Nine, claimed to be directing human civilization; the transcript record is *The Only Planet of Choice*. Gene Roddenberry is recorded attending the sessions at Puharich's Ossining estate in 1974–75. The elect is now a channeled council, and the audience is a television franchise.
