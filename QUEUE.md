...
## Resume pointer
`PHASE: C · State Laboratory head essay 'the-seed-and-the-flood' SHIPPED via two-key gate (both keys REVISE→PASS; method-narration/apparatus-vocab leaks cut). Reading 'The State Laboratory' registered PROVISIONAL in READINGS.md Planned block — homepage override window OPEN (one full phase), then promotes to live Reading V if unopposed. NEXT: §G eugenics theater (Goddard/Yerkes/Davenport/British Eugenics Society/HBF), off enactment per R-Q1 — harvest first. THEN: further Phase C growth (§C Music / §E Religion / §D Film, each harvest-gated).`
