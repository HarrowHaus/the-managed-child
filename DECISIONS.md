...
**S-14 · Umbrella name: *The Reverberation*** *(settled 2026-07-13; resolves D-2.)* The project is titled **The Reverberation** — the mechanism every reading shares — with **The Managed Child** as **Reading I, the founding territory**, not the umbrella. *Rationale: the managed child is now one reading of six; a spine titled for one reading understates the corpus. The homepage already shipped as The Reverberation (INTAKE 5); this ruling makes it settled and retitles the THESIS spine to match. The name survives every future rail. Operator ruling, 2026-07-13.* (AUDIT-2 Finding 8 / MASTER-SPEC 1.5 / AUDIT-3 Finding 8.)
...
**D-2 · Umbrella name.** ✅ **RESOLVED → S-14** (*The Reverberation*, with The Managed Child as Reading I).
