...
welds:
  - {to: managed-child, type: restates, register: convergent-selection, grade: WELD, source: "childrearing by mass-market expert manual at the scale of tens of millions of homes — the child managed by the book, even when the book counsels warmth"}
  - {to: watson-john-b, type: restates, register: common-inheritance, grade: WELD, source: "the humane correction to behaviorist detachment — the same domain of expert childrearing advice, the opposite counsel"}
