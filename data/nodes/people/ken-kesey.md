...
status: drafted
sources:
  - "Ken Kesey's own account, relayed in Tom Wolfe, The Electric Kool-Aid Acid Test (1968), and in Kesey's interviews — as a Stanford graduate student he volunteered as a paid subject (~$75/session) in a Menlo Park VA Hospital psychoactive-drug study (invited by his Perry Lane neighbour Vic Lovell), first took LSD there, and worked as a night aide — the experience behind One Flew Over the Cuckoo's Nest — [PRIMARY]"
  - "Robert Hunter (later Grateful Dead lyricist), same Stanford-connected drug-study milieu (~$140): 'At first, they gave me LSD, then the next week… mescaline, the next week… psilocybin, and the fourth week it was all three at once' — https://en.wikipedia.org/wiki/Robert_Hunter_(lyricist) — [PRIMARY]"
...
> **WELD** · map node 5.15 · 1935-2001

The paid subject who became the dispersal — the documented hinge from the state's LSD research into the mass counterculture, and the rail's cleanest firewall.
