---
id: cameron-allan-memorial
title: "Cameron & the Allan Memorial (Subproject 68)"
type: event
category: events
dates: "1957-1964"
grade: WELD
map_node: "5.6"
status: drafted
abstract: "The documented Canadian chapter of MKUltra: psychiatrist Donald Ewen Cameron, at McGill's Allan Memorial Institute in Montreal (1957–1964), ran 'depatterning' and 'psychic driving' — megadose ECT, LSD, sensory deprivation — funded as MKUltra Subproject 68 through a CIA front. In 1992 the Canadian government compensated 77 survivors; a class action proceeds. It is documented, and it has no documented connection to the Process Church — a gap stated, not bridged."
sources:
  - "Project MKULTRA joint hearing, 95th Cong., 3 Aug. 1977 — the surviving financial records documenting the CIA's subprojects, including the Cameron funding through the Society for the Investigation of Human Ecology — [PRIMARY]"
...
> **WELD** · map node 5.6 · 1957-1964

The documented Canadian MKUltra, and a gap kept open on purpose.
