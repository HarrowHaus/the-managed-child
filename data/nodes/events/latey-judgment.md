...
map_node: "5.11"
status: drafted
abstract: "Scientology's account of L. Ron Hubbard's role in Jack Parsons's Pasadena occult circle — that he was an undercover officer 'sent in to handle' a black-magic group — was rejected in open court by Mr Justice Latey (UK, 1984): 'He was not. He was himself a member of that occult group and practised ritual sexual magic in it.' A too-clean cover story, contradicted from the bench."
sources:
...
> **WELD** · map node 5.11 · 1984

A cover story, contradicted from the bench.
