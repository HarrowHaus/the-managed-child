...
map_node: "Rail5"
status: locked
abstract: "Childhood remade from innocence to be protected into stock to be activated, measured, sorted, and administered by credentialed experts. The root applied to the young: Hall constitutes the developmental stage, Watson conditions it, Terman ranks and tracks it, the school system processes it."
sources:
  - "G. Stanley Hall, Adolescence (1904, 2 vols., D. Appleton) — coins the modern category; 'storm and stress' — [PRIMARY]"
  - "John B. Watson & Rosalie Rayner, Psychological Care of Infant and Child (1928, W. W. Norton) — 'not more babies but better brought up babies'; the ideal child 'has no great attachments to any place or person' — [PRIMARY]"
  - "Lewis M. Terman, 'Genius and Stupidity' (doctoral dissertation, Clark University, 1905; supervised by G. Stanley Hall) — [PRIMARY]"
  - "Lewis M. Terman, The Measurement of Intelligence (1916) — the Stanford revision of the Binet–Simon scale — [PRIMARY]"
...
welds:
  - {to: the-root, type: restates, register: common-inheritance, grade: WELD, source: "the managed child is the root applied to the young — raise the stock correctly"}
  - {to: hall-g-stanley, type: restates, register: convergent-selection, grade: WELD, source: "Adolescence (1904) constitutes childhood and adolescence as a managed developmental stage; Hall founded the child-study movement and was first president of the APA"}
  - {to: watson-john-b, type: restates, register: convergent-selection, grade: WELD, source: "Psychological Care of Infant and Child (1928) states the program: 'not more babies but better brought up babies'; engineered detachment as a design goal"}
  - {to: terman-lewis, type: restates, register: convergent-selection, grade: WELD, source: "the Stanford–Binet (1916) and Terman's proposal to classify children onto job-tracks — the child as measured, ranked, administratively sorted population"}
  - {to: cubberley-ellwood, type: restates, register: convergent-selection, grade: WELD, source: "Public School Administration (1916) states the manufacturing metaphor for schooling in the author's own words"}
hypotheses: []
...
Across the twentieth century childhood was remade from *innocence to be protected* into *stock to be activated, measured, sorted, and managed*. This node is `the-root` applied to the young: raise the stock correctly. Its evidence is documented sociology, primary-sourced, and it requires no esoteric input whatever.
...
- **Structure, not intent.** That the child is administered by credentialed experts is the invariant. Whether a given expert styled that administration as *liberation* (the progressive strain) or as *conditioning* (the behaviorist strain) does not change the structure — see `double-parentage`. Neither strain is evidence of esoteric intent.
