---
id: rule-by-trained-elite
title: "The Trunk: rule-by-trained-elite"
type: concept
category: concepts
dates: "-"
grade: WELD
map_node: "Cap.1"
status: locked
abstract: "The continuous Western doctrine that society is properly ordered by a trained guardian minority who shape the many — if need be through myth. Plato's philosopher-kings and noble lie, Bacon's Salomon's House, Fabian permeation. The trunk beneath every rail: the root's political form."
sources:
  - "Plato, Republic, Bk III, 414b–415c — the noble lie (γενναῖον ψεῦδος) / myth of the metals — [PRIMARY]"
  - "Plato, Republic, Bk V — the guardians' children raised in common — [PRIMARY]"
  - "Francis Bacon, New Atlantis (1627) — Salomon's House: 'we have consultations, which of the inventions and experiences which we have discovered shall be published, and which not; and take all an oath of secrecy for the concealing of those which we think fit to keep secret' — [PRIMARY]"
  - "Fabian Essays in Socialism (1889), ed. G. B. Shaw — seven essayists: Shaw, Sidney Webb, Sydney Olivier, Graham Wallas, William Clarke, Hubert Bland, Annie Besant — [PRIMARY]"
  - "Sidney Webb, The Labour Party on the Threshold (Fabian Tract No. 207, 1923) — chairman's address to the Labour Party conference, 26 June 1923; 'the inevitability of gradualness' — [PRIMARY]"
...
> **WELD** · map node Cap.1 · the continuous doctrine

The conviction that society is properly ordered by a trained guardian minority — who shape the many, if need be through myth — is not a twentieth-century invention and not a conspiracy. It is one of the most respectable and continuous doctrines in Western political thought, and it is the **trunk** from which the occult, technocratic, and child-management branches all grow. It is `the-root` (humanity as administrable stock) given a **political form**: someone fit must do the administering.
...
- **Machiavelli → Burnham** is carried as a `hypotheses` edge, not a weld: the map names *The Machiavellians* (1943) as the bridge from the taproot to the managerial thesis, but the text has not been read against the claim.
...
The trunk is also where the **denominator** lives. Most of the managed child (see `managed-child`) was built by secular institution-builders working squarely inside this tradition, with no esoteric tie whatever. The concession comes first, and it is what earns the reader's attention for the stranger material that follows.
