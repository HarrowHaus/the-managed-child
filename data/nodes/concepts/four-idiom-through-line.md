...
welds:
  ...
  - {to: puharich-andrija, type: restates, register: convergent-selection, grade: WELD, source: "the Nine idiom: a channeled council claiming to direct human evolution; transcript record in The Only Planet of Choice"}
  - {to: roddenberry-gene, type: influenced, register: direct-transmission, grade: WELD, source: "Roddenberry attended the Ossining sessions (1974–75, Schlemmer as medium) and was commissioned to write a screenplay from the material (Kripal 2011; transcript in The Only Planet of Choice); the further claim that the sessions shaped Star Trek's cosmology is discarded"}
hypotheses: []
...
- **Bailey's specific coinages** — the "New Group of World Servers," the "Great Invocation" — are now confirmed against her text (see `externalisation-hierarchy`): both appear in *The Externalisation of the Hierarchy* as her own vocabulary. The attribution is documented, no longer held open.
