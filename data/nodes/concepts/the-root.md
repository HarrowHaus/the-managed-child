---
id: the-root
title: "The Root: humanity as administrable stock"
type: concept
category: concepts
dates: "-"
grade: WELD
...
status: locked
sources:
  - "Plato, Republic, Bk III (noble lie), Bk V (guardian family) — [PRIMARY]"
  - "Crowley, Liber AL vel Legis I:10 — [PRIMARY]"
...
> **WELD** · map node Cap.0 · the deepest layer

The true object of the thesis is neither occultism nor any cabal. It is an **impulse**: *humanity is raw material — stock to be graded, guided, corrected, and administered toward a planned end by an elect fit to do it.*
